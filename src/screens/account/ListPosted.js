...
import ListMyPostExpire from './component_post/ListMyPostExpire';
import {connect} from 'react-redux';
const initialLayout = layout.screen.width;
class ListPosted extends Component {
  constructor(props) {
    super(props);
    this.state = {
      index: 0,
  ...
  render() {
    return (
      <View style={styles.container}>
        <HeaderTab navigation={this.props.navigation} title="投稿リスト" />
...
export default connect(mapStateToProps)(ListPosted);
